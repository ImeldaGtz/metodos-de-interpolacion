...
import com.example.lagnewexin.databinding.ActivityLagrangeLinearBinding;

public class lagrangeLinear extends AppCompatActivity {

    private AppBarConfiguration appBarConfiguration;
    private ActivityLagrangeLinearBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityLagrangeLinearBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        setSupportActionBar(binding.toolbar);

        // NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_lagrange_linear);
    ...
    public void calculateLagLin(View LL) {
        // Para mostrar
